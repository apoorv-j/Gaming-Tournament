...
public class PubgMatchDetailActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(PubgMatchDetailActivity.this);
                ...
                call.enqueue(new Callback<List<list_room_details>>() {
                    ...
                    public void onResponse(Call<List<list_room_details>> call, Response<List<list_room_details>> response) {
                        ...
                        else
                        {
                            ...
                            killPrize = findViewById(R.id.textView27);
                            winPrize = findViewById(R.id.textView26);
                            entryFee = findViewById(R.id.textView25);
                            type = findViewById(R.id.textView19);
                            mode = findViewById(R.id.textView20);
                            map = findViewById(R.id.textView21);
                            matchTitle = findViewById(R.id.textView18);
                            dateTime = findViewById(R.id.textView23);
    ...
    public void refreshParticipants(View view) {
        ...
        recyclerView =findViewById(R.id.md_recycler_view);
        ...
        ((ParticipantsViewModel) playerList).getDetails(this,item.getMatchID(),"pubg").observe(this, new Observer<List<list_participants>>() {
            @Override
    ...
    public void joinClickMatchDetails() {
        ...
        if(Integer.parseInt(user.getBalance())<Integer.parseInt(item.getEntryFee()))
        {
            ...
            nextBTN.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    dialog.dismiss();
                    Util.changeDrawerFragment(PubgMatchDetailActivity.this, new WalletFragment());
                }
            });
        }
    ...
    private void showSuccessDialog(final String playerNames)
    {
        mDialog.dismiss();
        progressDialog.show();
        ...
        call2.enqueue(new Callback<ResponseBody>() {
                ...
                try {
                    ...
                    if(s.equals("player_added_successfully"))
                    {
                        ...
                        home.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                             startActivity(new Intent(PubgMatchDetailActivity.this, MainActivity.class));
                            }
                        });
                    }
                } catch (IOException e) {
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDialog.dismiss();
                    ...
                    {   progressDialog.dismiss();
                        Toast.makeText(PubgMatchDetailActivity.this, "Add Money in Wallet", Toast.LENGTH_LONG).show();
                        Util.changeDrawerFragment(PubgMatchDetailActivity.this, new WalletFragment());
                    }
      ...
      private void roomDialog(final String dateTime, final String ID, final String pass) {
        ...
        play.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent localIntent = getPackageManager().getLaunchIntentForPackage("com.tencent.ig");
                if (localIntent != null)
                {
                    startActivity(localIntent);
                }
                else
                    Toast.makeText(PubgMatchDetailActivity.this, "PUBG Mobile not installed!", Toast.LENGTH_LONG).show();
            }
        });
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "Game : PUBG Mobile"+"\nMatch Date and time: "+dateTime+"\nRoom ID: "+ID+"\n Room Password: "+pass);
